    ...
    <div className="bg-gray-100 dark:bg-gray-900 flex items-center justify-center min-h-screen font-sans">
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        ...
        <div className="flex justify-center pt-4">
            <button className="px-6 py-2 font-semibold text-white bg-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-colors duration-300">
                Get Started
            </button>
        </div>
